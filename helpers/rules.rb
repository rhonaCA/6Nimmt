    def show_rules_page
        ...
        puts ' '
        puts 'This game has 104 cards, each bearing a number and 1 to 7 cattle heads icons that represent penalty points. A round of 10 turns is played where all players place one card of their choice out. The placed cards are placed on one of four rows according to the fixed rules. If the card needs to be placed onto a row that already has five cards than the player who place that card collects those five cards, which count as penalty points that are totalled up at the end of each round. Game will continue until a player collects 66 cattle heads or more, whereupon the player with the least cattle heads wins.'
        puts ' '
        puts ' '
        ...
        puts ' '
        puts 'Hi player, you are playing with 1 NPC in this game. Both of you will have 10 cards to start with each round. You will see 4 initial set up cards placed vertically on the screen and your own cards that have be arranged in ascending order.'
        puts ' '
    ...
    "
        ...
        puts ' '
        puts 'After 10 turns, the game will count the cattle heads on the cards gathered during the round, keep score of each player and a new hand will start.'
        puts ' '
        puts 'The game will end when you or NPC collect a total of 66 or more cattle heads. Whoever has collected the fewest cattle heads is the winner!'
        puts ' '
